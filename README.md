...
*Note: cmake can also be installed using brew, brew install cmake*
...
Then, open the newly created solution file located here: `build\saleae-logic-SimpleParallelNoClock-Analyzer.sln`